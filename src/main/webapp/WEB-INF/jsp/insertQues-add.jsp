...
<div id="main" class="wrap">
    <div class="main">
        <h2>新增填空题</h2>
        <div class="manage">
            <form action="/insertques/addInsertQues.action" method="post">
                <table class="form">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="text" name="icontent" value="" /></td>
                    </tr>
                    <tr>
                        <td class="field">答案：</td>
                        <td><input type="text" class="text" name="ianswer" value="" /></td>
                    </tr>
                    <tr>
                        <td class="field">难度：</td>
                        <%--<td><input type="text" class="text" name="ilevel" value="" /></td>--%>
                        <td>
                            <select name="slevel">
