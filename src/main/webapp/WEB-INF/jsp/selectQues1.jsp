...
<div id="cc" class="easyui-layout" style="width:1366px;height:631px;margin:-8px ">
    ...
    <div data-options="region:'south',title:''" style="height:10px;">
    </div>
    ...
    <div data-options="region:'center',title:'&nbsp;&nbsp;&nbsp;&nbsp;真题'" style="padding:5px;background:#eee;">
        <div align="center">
            <div style="font-size:20px;color: #0000FF" align="left">&nbsp;&nbsp;选择题</div>
            <ul>

             <c:forEach items="${selectQues1List}" var="selectQues1">
                <li>
                    <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
                        <tr align="center">
                            <td width="8%"  valign="top">题目：</td><td colspan="6" align="left">${selectQues1.scontent}</td>
                            <td width="17%">难度${selectQues1.slevel}</td>
                        </tr>
                        <tr align="center">
                            <td width="8%">(A)</td><td width="17%" align="left">${selectQues1.sa}</td>
                            <td width="8%">(B)</td><td width="17%" align="left">${selectQues1.sb}</td>
                            <td width="8%">(C)</td><td width="17%" align="left">${selectQues1.sc}</td>
                            <td width="8%">(D)</td><td width="17%" align="left">${selectQues1.sd}</td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
