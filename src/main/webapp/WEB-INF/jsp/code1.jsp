...
<div id="cc" class="easyui-layout" style="width:1366px;height:631px;margin:-8px ">
    ...
    <div data-options="region:'center',title:'&nbsp;&nbsp;&nbsp;&nbsp;真题'" style="padding:5px;background:#eee;">
        <div align="center">
            <div style="font-size:20px;color: #0000FF" align="left">&nbsp;&nbsp;编程题</div>
            <br>
            <ul>

                <c:forEach items="${code1List}" var="code1">
                    <li>
                        <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
                            <tr align="center">
                                <td width="8%" valign="top">题目:</td><td colspan="6" align="left">${code1.ccontent}</td>
                                <td width="17%">难度${code1.clevel}</td>
                            </tr>
                            <tr align="center">
                                <td colspan="8">&nbsp;</td>
                            </tr>
