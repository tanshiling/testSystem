...
<div id="cc" class="easyui-layout" style="width:1366px;height:631px;margin:-8px ">
    ...
    <div data-options="region:'center',title:'&nbsp;&nbsp;&nbsp;&nbsp;真题'" style="padding:5px;background:#eee;">
        <div align="center">
            <div style="font-size:20px;color: #0000FF" align="left">&nbsp;&nbsp;综合应用题</div>
            <br>
            <ul>

                <c:forEach items="${application1List}" var="application1">
                    <li>
                        <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
                            <tr align="center">
                                <td width="8%"  valign="top">题目:</td><td colspan="6" align="left">${application1.acontent}</td>
                                <td width="17%">难度${application1.alevel}</td>
                            </tr>
                            <tr align="center">
                                <td>&nbsp;</td>
                                <td colspan="7" align="left"><img alt="" src="/img/${application1.apicture}"></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
